...
import a.b.c.autovcs.forms.PopulateDataForm;
...
import a.b.c.autovcs.services.GHRepositoryService;
...
public class APIRepositoryController extends APIController {
    ...
    public ResponseEntity populateRepositories ( @RequestBody final PopulateDataForm form ) {
        ...
        for ( final GHRepository repo : repos ) {
             ...
             * updates
             */
            a.b.c.autovcs.models.persistent.GHRepository repoToSave = repositoryService
            ...
            if ( null == repoToSave ) {
                repoToSave = new a.b.c.autovcs.models.persistent.GHRepository();
            ...
            if ( form.getCommit() ) {
                ...
                final Collection<a.b.c.autovcs.models.persistent.GHCommit> newCommits = getCommitsOnRepo( repo,
    ...
    private boolean checkForDuplicateMembers ( final a.b.c.autovcs.models.persistent.GHRepository repoToSave,
    ...
    private List<a.b.c.autovcs.models.persistent.GHPullRequest> getPullRequestsForRepo (
            final GHRepository repo ) {
        final List<a.b.c.autovcs.models.persistent.GHPullRequest> requestsToSave = new ArrayList<a.b.c.autovcs.models.persistent.GHPullRequest>();
        try {
    ...
    private Collection<a.b.c.autovcs.models.persistent.GHCommit> getCommitsOnRepo ( final GHRepository repo,
            final a.b.c.autovcs.models.persistent.GHRepository persistentRepo, final Boolean includeAll ) {
        final Map<String, a.b.c.autovcs.models.persistent.GHCommit> allCommitsForRepo = new HashMap<String, a.b.c.autovcs.models.persistent.GHCommit>();
        try {
             ...
             */
            final a.b.c.autovcs.models.persistent.GHCommit mostRecent = commitService
            ...
            repo.getBranches().values().forEach( branch -> {
                ...
                allForBranch.stream().forEach( commit -> {
                    ...
                    if ( allCommitsForRepo.containsKey( commitHash ) ) {
                        ...
                        final a.b.c.autovcs.models.persistent.GHCommit parsed = commitService.forCommit( commit,
                                branch.getName() );
    ...
    public ResponseEntity getRepositoryBranches ( @PathVariable final String organisation,
        ...
        final a.b.c.autovcs.models.persistent.GHRepository repo = repositoryService
    ...
    public ResponseEntity getRepositoryMembers ( @PathVariable final String organisation,
        ...
        final List<a.b.c.autovcs.models.persistent.GHPullRequest> PRs = prService.findByRepository( repo );
    ...
    public ResponseEntity getRepositories () {
         ...
         */
        final List<a.b.c.autovcs.models.persistent.GHRepository> repos = repositoryService.findAll();
        return new ResponseEntity( repos.stream().map( a.b.c.autovcs.models.persistent.GHRepository::format )
