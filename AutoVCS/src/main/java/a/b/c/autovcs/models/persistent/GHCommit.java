package a.b.c.autovcs.models.persistent;
...
public class GHCommit extends DomainObject {
    ...
    public void setFiles ( final List<File> filesOnCommit ) {
        if ( null == this.files ) {
            this.files = new HashSet<a.b.c.autovcs.models.persistent.GHFile>();
        }
        filesOnCommit
                .forEach( file -> this.files.add( new a.b.c.autovcs.models.persistent.GHFile( file, this ) ) );
    }
